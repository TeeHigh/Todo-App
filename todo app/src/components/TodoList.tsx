...
const TodoList: React.FC<TodoListProps> = ({ currentTab, todoList, setTodoList, deleteTodoItem, children }) => {
  const activeItems = todoList.filter((item) => !item.completed).length
          ...
          todoList.length === 0
            ...
            <>
              ...
              {currentTab === 'active' && (
                ...
                :
                <ActiveListItems todoList={todoList} setTodoList={setTodoList} deleteTodoItem={deleteTodoItem} />
              )
              }
              {currentTab === 'completed' && (
                !completedItems ?
                  ...
                  :
                  <CompletedListItems todoList={todoList} setTodoList={setTodoList} deleteTodoItem={deleteTodoItem} />
              )}
            </>
        }
      </div>
